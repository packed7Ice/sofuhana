...
const elements = {
  ...
  playerDeclarationStatus: document.getElementById('player-declaration-status'),
  playerDeclarationDetail: document.getElementById('player-declaration-detail'),
  cpuDeclarationStatus: document.getElementById('cpu-declaration-status'),
  cpuDeclarationDetail: document.getElementById('cpu-declaration-detail'),
